...
contract MoodNftIntegrationTest is Test {
    ...
    function testFlipTokenTosad() public {
        ...
        // 1. Recreate the exact JSON string that the contract generates
        ...
        // 2. Compare the generated string with the contract's output
        assert(keccak256(abi.encodePacked(moodNft.tokenURI(0))) == keccak256(abi.encodePacked(expectedTokenUri)));
    }
}
